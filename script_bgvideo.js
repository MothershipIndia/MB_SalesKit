var mainFunction = 
{
	...
	defaultSettings: function(){
		...
		function onResize(){
			$(mainFunction.elements.progress).width( $(mainFunction.elements.playerContainer).width());
			$(mainFunction.elements.progressBackground).width( $(mainFunction.elements.playerContainer).width());		
			$(mainFunction.elements.progressHidden).width( $(mainFunction.elements.playerContainer).width());		
			mainFunction.progressBarHeight = $(mainFunction.elements.playerContainer).width();
	...
	mouseHideControl: function(){
		...
		function onMouseHide(){ $(".player-container").css("cursor", "none"); }

		function onMouseShow(){ $(".player-container").css("cursor", "inherit"); }
	...
	progressControlVideo: function(){
		...
		$(mainFunction.elements.progressHidden).on("mouseup", function(){ isDown = false; if(!mainFunction.isEnd) {  } });

		$(mainFunction.elements.progressHidden).on("mouseout", function(){ isDown = false; if(!mainFunction.isEnd) {   } });
